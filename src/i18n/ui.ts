...
const en = {
  site: {
    nav: { about: `How we work`, projects: `Projects`, contact: `Contact` },
    theme: { dark: `dark`, light: `light` },
    hero: {
      eyebrow: `Nostr · Lightning · Bitcoin`,
      titleHtml: `Your stack, built on<br><span class="accent">open protocols</span>.`,
      subcopy: `Tell us what you need to build. We come back with how to build it on free software and open protocols — and every layer we write is yours to run, keep and fork.`,
      explore: `See what we build`,
      learn: `How we work`,
    },
    services: [
      {
        title: `Custom development`,
        copy: `Tell us what you need to build. We come back with the shortest path that actually works — architecture, cost and timeline — then build it.`,
      },
      {
        title: `Bitcoin, Lightning & Nostr`,
        copy: `Payments, identity and messaging on open protocols. Wallets, nodes, relays and integrations, wired into your product.`,
      },
      {
        title: `Self-hosting & operations`,
        copy: `We deploy the stack on your own infrastructure and keep it running. Your servers, your keys, your data.`,
      },
      {
        title: `Yours to keep`,
        copy: `Open licences, readable code, documented handover. You stay with us because you want to, not because you're locked in.`,
      },
    ],
    about: {
      label: `How we work`,
      title: `We build with free software, on purpose`,
      copy: `ProtoLayer OÜ is a technology company registered in Estonia. We build on Bitcoin, Lightning and Nostr because open protocols outlive the companies that adopt them: no vendor can revoke your access, raise your rent, or switch off the layer you depend on. You get the source, the deployment scripts and the documentation — and the option to walk away with all of it.`,
    },
    projects: {
      title: `What we've built`,
      tag: `Open source`,
      chokeDesc: `Real-time BJJ match scoring, running on Nostr. Run the table from your phone and stream the scoreboard live to spectators — no accounts, and no servers of ours in the middle.`,
      soon: `More projects\ncoming soon`,
    },
    contact: {
      title: `Tell us what you need to build`,
      subtitle: `Describe the problem — we'll come back with how we'd build it, what it takes, and what it costs.`,
    },
    footer: { tagline: `Free software. Open protocols.`, reg: `Reg. no.` },
    // Strings unique to the "terminal-editorial" design variant.
    te: {
      heroEyebrow: `Estonia · Est. 2026`,
      heroTitleHtml: `Your stack, built on<br><span class="accent">open protocols</span>`,
      servicesLabel: `What we do`,
      aboutLabel: `01 — How we work`,
      aboutTitle: `We build with free software, on purpose`,
      aboutTags: [`◇ Bitcoin`, `◇ Lightning`, `◇ Nostr`],
      projectsTag: `02 — Open source`,
      chokeDesc: `Real-time BJJ match scoring on Nostr, with live public scoreboards.`,
    },
    meta: {
      title: `ProtoLayer OÜ — Custom development on Bitcoin, Lightning and Nostr`,
      desc: `Estonian technology company building custom software on free technologies and open protocols — Bitcoin, Lightning and Nostr. Development, self-hosting and operations, with no vendor lock-in.`,
    },
  },
  choke: {
    nav: {
    ...
    how: {
      ...
      steps: [
        { title: `Connect your account`, desc: `Open Choke and your account is ready — a secure key is created on the device, no sign-up. That key is your identity, and every match you run is published under it.` },
        ...
        { title: `Share the board`, desc: `Open <b>Account</b> and tap <b>Share live board</b>: Choke hands you a <a class="gold-link" href="https://bjjscore.live" target="_blank" rel="noopener">bjjscore.live</a> link with your key already in it. Send that one link to anyone — they watch the scoreboard live, with no separate key to pass along.` },
      ],
    },
    showcase: {
...
const es: typeof en = {
  site: {
    nav: { about: `Cómo trabajamos`, projects: `Proyectos`, contact: `Contacto` },
    theme: { dark: `oscuro`, light: `claro` },
    hero: {
      eyebrow: `Nostr · Lightning · Bitcoin`,
      titleHtml: `Tu stack, sobre<br><span class="accent">protocolos libres</span>.`,
      subcopy: `Cuéntanos qué necesitas construir. Te decimos cómo hacerlo con software libre y protocolos abiertos — y cada capa que escribimos queda tuya: para usarla, operarla y modificarla.`,
      explore: `Ver lo que construimos`,
      learn: `Cómo trabajamos`,
    },
    services: [
      {
        title: `Desarrollo a medida`,
        copy: `Cuéntanos qué necesitas construir. Volvemos con el camino más corto que de verdad funciona — arquitectura, costo y plazos — y lo construimos.`,
      },
      {
        title: `Bitcoin, Lightning y Nostr`,
        copy: `Pagos, identidad y mensajería sobre protocolos abiertos. Wallets, nodos, relays e integraciones, conectados a tu producto.`,
      },
      {
        title: `Self-hosting y operación`,
        copy: `Desplegamos el stack en tu propia infraestructura y lo mantenemos funcionando. Tus servidores, tus claves, tus datos.`,
      },
      {
        title: `Queda tuyo`,
        copy: `Licencias abiertas, código legible, entrega documentada. Sigues con nosotros porque quieres, no porque estés atado.`,
      },
    ],
    about: {
      label: `Cómo trabajamos`,
      title: `Construimos con software libre, a propósito`,
      copy: `ProtoLayer OÜ es una empresa de tecnología registrada en Estonia. Construimos sobre Bitcoin, Lightning y Nostr porque los protocolos abiertos sobreviven a las empresas que los adoptan: ningún proveedor puede revocarte el acceso, subirte el alquiler ni apagar la capa de la que dependes. Te entregamos el código fuente, los scripts de despliegue y la documentación — y la opción de llevarte todo.`,
    },
    projects: {
      title: `Lo que construimos`,
      tag: `Código abierto`,
      chokeDesc: `Puntuación de combates de BJJ en tiempo real, sobre Nostr. Maneja la mesa desde tu teléfono y transmite el marcador en vivo a los espectadores — sin cuentas y sin servidores nuestros en el medio.`,
      soon: `Más proyectos\npróximamente`,
    },
    contact: {
      title: `Cuéntanos qué necesitas construir`,
      subtitle: `Descríbenos el problema y te decimos cómo lo construiríamos, qué requiere y cuánto cuesta.`,
    },
    footer: { tagline: `Software libre. Protocolos abiertos.`, reg: `Reg. núm.` },
    te: {
      heroEyebrow: `Estonia · Est. 2026`,
      heroTitleHtml: `Tu stack, sobre<br><span class="accent">protocolos libres</span>`,
      servicesLabel: `Qué hacemos`,
      aboutLabel: `01 — Cómo trabajamos`,
      aboutTitle: `Construimos con software libre, a propósito`,
      aboutTags: [`◇ Bitcoin`, `◇ Lightning`, `◇ Nostr`],
      projectsTag: `02 — Código abierto`,
      chokeDesc: `Puntuación de BJJ en tiempo real sobre Nostr, con marcadores públicos en vivo.`,
    },
    meta: {
      title: `ProtoLayer OÜ — Desarrollo a medida sobre Bitcoin, Lightning y Nostr`,
      desc: `Empresa de tecnología estonia que construye software a medida con tecnologías libres y protocolos abiertos — Bitcoin, Lightning y Nostr. Desarrollo, self-hosting y operación, sin dependencia de proveedores.`,
    },
  },
  choke: {
    nav: {
    ...
    how: {
      ...
      steps: [
        { title: `Conecta tu cuenta`, desc: `Abre Choke y tu cuenta ya está lista — se crea una clave segura en el dispositivo, sin registro. Esa clave es tu identidad, y cada combate que dirijas se publica con ella.` },
        ...
        { title: `Comparte el marcador`, desc: `Abre <b>Cuenta</b> y toca <b>Compartir marcador</b>: Choke te da un enlace de <a class="gold-link" href="https://bjjscore.live" target="_blank" rel="noopener">bjjscore.live</a> con tu clave ya incluida. Envía ese único enlace a quien quieras — verá el marcador en vivo, sin mandar la clave por separado.` },
      ],
    },
    showcase: {
...
const pt: typeof en = {
  site: {
    nav: { about: `Como trabalhamos`, projects: `Projetos`, contact: `Contato` },
    theme: { dark: `escuro`, light: `claro` },
    hero: {
      eyebrow: `Nostr · Lightning · Bitcoin`,
      titleHtml: `Seu stack, sobre<br><span class="accent">protocolos livres</span>.`,
      subcopy: `Conte o que você precisa construir. A gente diz como fazer com software livre e protocolos abertos — e cada camada que escrevemos fica sua: para usar, operar e modificar.`,
      explore: `Ver o que construímos`,
      learn: `Como trabalhamos`,
    },
    services: [
      {
        title: `Desenvolvimento sob medida`,
        copy: `Conte o que você precisa construir. Voltamos com o caminho mais curto que realmente funciona — arquitetura, custo e prazo — e construímos.`,
      },
      {
        title: `Bitcoin, Lightning e Nostr`,
        copy: `Pagamentos, identidade e mensageria sobre protocolos abertos. Carteiras, nós, relays e integrações, ligados ao seu produto.`,
      },
      {
        title: `Self-hosting e operação`,
        copy: `Implantamos o stack na sua própria infraestrutura e mantemos tudo no ar. Seus servidores, suas chaves, seus dados.`,
      },
      {
        title: `Fica seu`,
        copy: `Licenças abertas, código legível, entrega documentada. Você continua com a gente porque quer, não porque está preso.`,
      },
    ],
    about: {
      label: `Como trabalhamos`,
      title: `Construímos com software livre, de propósito`,
      copy: `A ProtoLayer OÜ é uma empresa de tecnologia registrada na Estônia. Construímos sobre Bitcoin, Lightning e Nostr porque protocolos abertos sobrevivem às empresas que os adotam: nenhum fornecedor pode revogar seu acesso, aumentar seu aluguel ou desligar a camada da qual você depende. Você recebe o código-fonte, os scripts de implantação e a documentação — e a opção de levar tudo embora.`,
    },
    projects: {
      title: `O que construímos`,
      tag: `Código aberto`,
      chokeDesc: `Pontuação de lutas de BJJ em tempo real, sobre Nostr. Comande a mesa pelo celular e transmita o placar ao vivo para os espectadores — sem contas e sem servidores nossos no meio.`,
      soon: `Mais projetos\nem breve`,
    },
    contact: {
      title: `Conte o que você precisa construir`,
      subtitle: `Descreva o problema e dizemos como construiríamos, o que envolve e quanto custa.`,
    },
    footer: { tagline: `Software livre. Protocolos abertos.`, reg: `Reg. nº` },
    te: {
      heroEyebrow: `Estônia · Est. 2026`,
      heroTitleHtml: `Seu stack, sobre<br><span class="accent">protocolos livres</span>`,
      servicesLabel: `O que fazemos`,
      aboutLabel: `01 — Como trabalhamos`,
      aboutTitle: `Construímos com software livre, de propósito`,
      aboutTags: [`◇ Bitcoin`, `◇ Lightning`, `◇ Nostr`],
      projectsTag: `02 — Código aberto`,
      chokeDesc: `Pontuação de BJJ em tempo real sobre Nostr, com placares públicos ao vivo.`,
    },
    meta: {
      title: `ProtoLayer OÜ — Desenvolvimento sob medida em Bitcoin, Lightning e Nostr`,
      desc: `Empresa de tecnologia estoniana que constrói software sob medida com tecnologias livres e protocolos abertos — Bitcoin, Lightning e Nostr. Desenvolvimento, self-hosting e operação, sem dependência de fornecedores.`,
    },
  },
  choke: {
    nav: {
    ...
    how: {
      ...
      steps: [
        { title: `Conecte sua conta`, desc: `Abra o Choke e sua conta já está pronta — uma chave segura é criada no dispositivo, sem cadastro. Essa chave é a sua identidade, e cada luta que você conduz é publicada com ela.` },
        ...
        { title: `Compartilhe o placar`, desc: `Abra <b>Conta</b> e toque em <b>Compartilhar placar</b>: o Choke te dá um link do <a class="gold-link" href="https://bjjscore.live" target="_blank" rel="noopener">bjjscore.live</a> com a sua chave já incluída. Envie esse único link para quem quiser — a pessoa vê o placar ao vivo, sem enviar a chave separadamente.` },
      ],
    },
    showcase: {
